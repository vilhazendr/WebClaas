...
async function initDb() {
  ...
  await pool.query(`INSERT INTO users(role,username,name,password_hash) VALUES('admin',$1,'Admin XI TKJ 1',$2) ON CONFLICT (username) DO UPDATE SET name=EXCLUDED.name`, [adminUser, adminHash]);
}
